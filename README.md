...
## Introduction
As a solution to needing to store tons of [these](https://forge.hackclub.com/projects/93) microdrones as well as the central compute unit, I designed a vertically mounting lift off platform and storage unit called the LS Mk.1 Drone Launcher. Its super modular so that it can be stacked on itself and easily stored in a grid and scale to any number of drones. The design is essentially a 3D printed platform with four metal rods for guiding the drones, the top and bottom half can separated or connected by opening or closing the latches. The platform currently has a capacity for 5 drones each.

For calculating and planning the trajectory of the drones, this launcher uses a Raspbbery Pi Zero 2 W along with a custom Pi hat. The custom Pi hat extends the wifi range of the Raspberry Pi Zero 2 W to communicate with the LS Anchors and adds a battery for independent usage from wall outlets. Only 1 compute module should be necessary per batch of launcher units.
...
| 4 | 20mm M2.5 Bolts | $10 | Reference (can find it cheaper elsewhere): [here](https://www.mcmaster.com/products/91290a108/)
| 16 | 16mm M2.5 Bolts | $10 | Reference (can find it cheaper elsewhere): [here](https://www.mcmaster.com/products/91290A106/)
| 20 | M2.5 Nuts | $10 | Reference (can find it cheaper elsewhere): [here](https://www.mcmaster.com/products/90591a270/)
...
- Print all parts of the case
- Assemble the launcher case and latch together
- Print drone landing gears and mount them
